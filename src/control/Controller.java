...
public class Controller {
	...
	public static void startGame(QuizGame game) {
	    for (Question question : game.getQuestions()) {
	        ...
	        while (!game.isValidAnswer(playerAnswer)) {
	            System.out.println("Not a valid answer, select a correct option please!");
	            playerAnswer = scanner.nextLine();
	        }

	        if (game.isCorrectThisAnswer(playerAnswer, question.getAnswers())) {
        ...
        if (game.getPlayerScore() >= 30) {
            feedbackMessage = "Congratulations !! Your score is " + game.getPlayerScore() + " points! You are a champ! :D";
        } else {
            feedbackMessage = "I'm afraid your score is " + game.getPlayerScore() + " points.. You lost the game! Better luck next time ;)";
        }
        System.out.println(feedbackMessage);
    }
