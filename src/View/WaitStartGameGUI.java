	...
	public WaitStartGameGUI(Controller theController){
		...
		Listener listener = new Listener() {
    	    public void received (Connection connection, Object object) {
    	        ...
    	        }else if (object instanceof String && object == "start") {
        ...
        JLabel lblLogin = new JLabel("Player name");
        lblLogin.setBounds(66, 11, 69, 14);
        contentPane.add(lblLogin);

        JLabel lblPwd = new JLabel("Rank");
        lblPwd.setBounds(173, 11, 62, 14);
        contentPane.add(lblPwd);

        // Bouton "Login"
        JButton btnLogin = new JButton("Login");
        btnLogin.setBounds(76, 375, 134, 23);
        contentPane.add(btnLogin);
        
        lblNewLabel = new JLabel("Time remaining :");
        lblNewLabel.setBounds(10, 354, 78, 14);
	...
	private void createGUI() {
		...
		swingTimer = new Timer(1000, new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				theTime--;
				timerLabel.setText("Timer " + theTime + "s");
				if (theTime <= 0) {
